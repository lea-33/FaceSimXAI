...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store",
        default=MAX_EPOCHS,
        help="Define number of training epochs. Default: 2",
    )
    ...
    parser.add_argument(
        ...
        action="store",
        default=32,
        help="Define N of total dataset size If not provided it will take all data. Default 32.",
    )
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Shuffle data before split. Default: True",
    )

    parser.add_argument(
        "--num_workers", type=int, action="store", default=0, help="Number of workers for dataloader. Default: 0"
    )
    ...
    parser.add_argument(
        ...
        action="store",
        default="maxp_5_3",
        help="Define the last layer of VGGFace to keep before the bridge module and decision block. Default: 'maxp_5_3'.",
    )
